...
<Image src={terepaimaAdminDashboard} alt="Terepaima admin dashboard" class="rounded-md shadow mx-auto my-6 w-full bg-white/70 dark:bg-white/5" />
...
<Image src={ownerDashboardImage} alt="Terepaima owner dashboard" class="rounded-md shadow mx-auto my-6 w-full bg-white/70 dark:bg-white/5" />
