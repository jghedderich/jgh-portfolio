---
title: Hola Condominio (Terepaima)
slug: terepaima
description: Web admin dashboard for condominium management (owners + admins)
order: 90
...
<Image src={terepaimaAdminDashboard} alt="Terepaima admin dashboard" class="rounded-md shadow mx-auto my-6 max-w-5xl bg-white/70 dark:bg-white/5" />
...
<Image src={ownerDashboardImage} alt="Terepaima owner dashboard" class="rounded-md shadow mx-auto my-6 max-w-5xl bg-white/70 dark:bg-white/5" />
