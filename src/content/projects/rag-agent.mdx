...
<Image src={ingestKnowledgeImage} alt="Micro-frontend architecture and the AI triage chat module" class="rounded-md shadow mx-auto my-6 max-w-5xl bg-white/70 dark:bg-white/5" />
...
<Image src={langgraphLogicImage} alt="Human handover flow: query, analysis, retrieval, and escalation to a human agent when needed" class="rounded-md shadow mx-auto my-6 max-w-5xl bg-white/70 dark:bg-white/5" />
...
<Image src={metricsImage} alt="Analytics dashboard: AI vs. Human intervention and top-performing documents" class="rounded-md shadow mx-auto my-6 max-w-5xl bg-white/70 dark:bg-white/5" />
