...
<Image src={productsImage} alt="Agroshow product catalog UI" class="rounded-md shadow mx-auto my-6 w-full" />
...
<Image src={searchImage} alt="Agroshow search and autocomplete" class="rounded-md shadow mx-auto my-6 w-full" />
...
<Image src={adminImage} alt="Agroshow admin dashboard" class="rounded-md shadow mx-auto my-6 w-full" />
...
<Image src={chatImage} alt="Agroshow chat interface" class="rounded-md shadow mx-auto my-6 w-full" />
...
<Image src={mapImage} alt="Agroshow map view" class="rounded-md shadow mx-auto my-6 w-full" />
