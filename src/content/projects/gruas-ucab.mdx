...
<Image src={createOrder} alt="Creating a towing order in the admin UI" class="rounded-md shadow mx-auto my-6 max-w-4xl" />
...
<Image src={orderDetail} alt="Towing order detail and pricing" class="rounded-md shadow mx-auto my-6 max-w-4xl" />
...
<Image src={vehicles} alt="Provider vehicles management" class="rounded-md shadow mx-auto my-6 max-w-4xl" />
...
<Image src={deploy} alt="Deployment architecture diagram" class="rounded-md shadow mx-auto my-6 max-w-4xl" />
